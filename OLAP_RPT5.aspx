<%@ page title="" language="C#" masterpagefile="~/MainPage.master" autoeventwireup="true" inherits="OLAP_RPT5, App_Web_olap_rpt5.aspx.cdcab7d2" %>
                ...
                <ContentCollection>
                    <dx:ContentControl runat="server" SupportsDisabledAttribute="True">
                                                    ...
                                                    <td>
                                                        <dx:ASPxPivotGrid ID="ASPxPivotGrid1" runat="server" ClientIDMode="AutoID" 
                                                            ...
                                                            <Fields>
                                                                ...
                                                                <dx:PivotGridField ID="fieldfmemo" Area="ColumnArea" AreaIndex="0" Caption="期間" 
                                                                    FieldName="f_memo">
                                                                    <CellStyle Font-Names="王漢宗細圓體繁">
                                                                    </CellStyle>
                                                                    <ValueStyle Font-Names="王漢宗細圓體繁">
                                                                ...
                                                                <dx:PivotGridField ID="fieldQTY" Area="DataArea" AreaIndex="0" Caption="來客數" 
                                                                    FieldName="QTY">
                                                                    <CellStyle Font-Names="王漢宗細圓體繁">
                                                                    </CellStyle>
                                                                    <ValueStyle Font-Names="王漢宗細圓體繁">
                                                                ...
                                                                <dx:PivotGridField ID="fieldecrno" AreaIndex="1" Caption="機號" 
                                                                    FieldName="ecr_no">
                                                                    <CellStyle Font-Names="王漢宗細圓體繁">
                                                                    </CellStyle>
                                                                    <ValueStyle Font-Names="王漢宗細圓體繁">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                            ...
                            OnSelected="SqlDataSource2_Selected" OnSelecting="SqlDataSource2_Selecting" SelectCommand="exec dbo.OLAP_RPT5 @BEGDT, @ENDDT, @STORE_NO
">
                            <SelectParameters>
