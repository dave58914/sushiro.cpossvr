<%@ page title="" language="C#" masterpagefile="~/MainPage.master" autoeventwireup="true" inherits="ECR_PostDoc, App_Web_ecr_postdoc.aspx.cdcab7d2" %>
                                                ...
                                                <dx:GridViewDataTextColumn Caption="內容" FieldName="DESCRIPTIONHTML" 
                                                    ...
                                                    <EditItemTemplate>
                                                        <dx:ASPxMemo ID="ASPxMemo1" runat="server" Font-Names="王漢宗細圓體繁" 
                                                            Font-Size="Small" Height="400px" HorizontalAlign="Left" 
                                                            Text='<%# Bind("DESCRIPTIONHTML") %>' Width="800px">
                                                        </dx:ASPxMemo>
                                                    </EditItemTemplate>
                                                </dx:GridViewDataTextColumn>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <dx:ASPxTextBox ID="tbFILES1" runat="server" BackColor="#CCCCCC" 
                                                                            ClientInstanceName="txtFILES1" Font-Names="王漢宗細圓體繁" Height="24px" 
                                                                            NullText="可新增附件檔案" ReadOnly="True" Text='<%# GetFiles("tbFILES1") %>' 
                                                                            Width="500px">
                                                                ...
                                                                <tr>
                                                                    <td class="style14">
                                                                        <dx:ASPxTextBox ID="tbFILES2" runat="server" BackColor="#CCCCCC" 
                                                                            ClientInstanceName="txtFILES2" Font-Names="王漢宗細圓體繁" Height="24px" 
                                                                            NullText="可新增附件檔案" ReadOnly="True" Text='<%# GetFiles("tbFILES2") %>' 
                                                                            Width="500px">
                                                                            <Border BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" />
                                                                        </dx:ASPxTextBox>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td class="style17">
                                                                        <dx:ASPxTextBox ID="tbFILES3" runat="server" BackColor="#CCCCCC" 
                                                                            ClientInstanceName="txtFILES3" Font-Names="王漢宗細圓體繁" Height="24px" 
                                                                            NullText="可新增附件檔案" ReadOnly="True" Text='<%# GetFiles("tbFILES3") %>' 
                                                                            Width="500px">
                                                                            <Border BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" />
                                                                        </dx:ASPxTextBox>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <dx:ASPxTextBox ID="tbFILES4" runat="server" BackColor="#CCCCCC" 
                                                                            ClientInstanceName="txtFILES4" Font-Names="王漢宗細圓體繁" Height="24px" 
                                                                            NullText="可新增附件檔案" ReadOnly="True" Text='<%# GetFiles("tbFILES4") %>' 
                                                                            Width="500px">
                                                                            <Border BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" />
                                                                        </dx:ASPxTextBox>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <dx:ASPxTextBox ID="tbFILES5" runat="server" BackColor="#CCCCCC" 
                                                                            ClientInstanceName="txtFILES5" Font-Names="王漢宗細圓體繁" Height="24px" 
                                                                            NullText="可新增附件檔案" ReadOnly="True" Text='<%# GetFiles("tbFILES5") %>' 
                                                                            Width="500px">
                                                                            <Border BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" />
                                                                        </dx:ASPxTextBox>
                                                                    </td>
			...
			txtFILES5.SetText(Value1);
                    ...
                    <br />
                        <asp:EntityDataSource ID="edsPOS_POSTDOC" runat="server" 
                            ...
                            EnableUpdate="True" EntitySetName="POS_postdoc" 
