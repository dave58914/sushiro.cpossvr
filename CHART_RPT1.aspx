<%@ page title="" language="C#" masterpagefile="~/MainPage.master" autoeventwireup="true" inherits="CHART_RPT1, App_Web_chart_rpt1.aspx.cdcab7d2" %>
                                    ...
                                    <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                        <div align="left">
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:Panel ID="Panel5" runat="server" Font-Names="王漢宗細圓體繁" Width="650px">
                                                            <table class="style8">
                                                                <tr>
                                                ...
                                                <tr>
                                                    <td align="left">
                                                            ...
                                                            <table class="style8">
                                                                <tr>
                                                                    <td align="right" style="font-family: 王漢宗細圓體繁; font-size: small">
                                                                        過濾條件</td>
                                                                    <td align="left">
                                                                        <dx:ASPxComboBox ID="cbKIND" runat="server" AutoPostBack="True" 
                                                                            Font-Names="王漢宗細圓體繁" Height="28px" 
                                                                            OnSelectedIndexChanged="cbKIND_SelectedIndexChanged" TextFormatString="{0}" 
                                                                            Width="60px">
                                                                            <Items>
                                                                                <dx:ListEditItem Text="金額" Value="金額" />
                                                                                <dx:ListEditItem Text="數量" Value="數量" />
                                                                            </Items>
                                                                        </dx:ASPxComboBox>
                                                                    </td>
                                                                    <td>
                                                                        <dx:ASPxCheckBox ID="cbShowLabels" runat="server" AutoPostBack="True" 
                                                                            ...
                                                                            OnCheckedChanged="cbShowLabels_CheckedChanged" Text="標籤">
                                                                    ...
                                                                    <td align="left">
                                                                        <dx:ASPxComboBox ID="cbSORT" runat="server" AutoPostBack="True" 
                                                                            Font-Names="王漢宗細圓體繁" Height="28px" 
                                                                            OnSelectedIndexChanged="cbSORT_SelectedIndexChanged" TextFormatString="{0}" 
                                                                            Width="140px">
                                                                            <Items>
                                                                                <dx:ListEditItem Text="前10" Value="前10" />
                                                                                <dx:ListEditItem Text="前20" Value="前20" />
                                                                                <dx:ListEditItem Text="最後10" Value="最後10" />
                                                                            </Items>
                                                                        </dx:ASPxComboBox>
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <asp:Panel ID="Panel7" runat="server" Width="200px">
                                                        ...
                                                        <asp:MultiView ID="MultiView1" runat="server">
                                                            <asp:View ID="View1" runat="server">
                                                                <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" 
                                                                    ClientInstanceName="chart" Height="400px" PaletteName="Pastel Kit" 
                                                                    Width="1000px">
...
<cc1:ToolTipMousePosition></cc1:ToolTipMousePosition>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                            ...
                            SelectCommand="exec dbo.CHART_RPT1 @BEGDT, @ENDDT, @STORE_NO">
                            <SelectParameters>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource5" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:NEWPMSConnectionString %>" 
                            SelectCommand="select * from (select '00'comcode,@P3'f',@P3'f_memo',@P3'class_name', 0'QTY',@P1'AMOUNT',0'QTYS',0'AMOUNTS' union all select '00'comcode,'總金額占比'f,'總金額占比'f_memo,'總金額占比'class_name, 0'QTY',@P2'AMOUNT',0'QTYS',0'AMOUNTS')tt">
                            <SelectParameters>
                                <asp:Parameter Name="P3" />
