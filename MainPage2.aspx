<%@ page title="" language="C#" masterpagefile="~/MainPage.master" autoeventwireup="true" inherits="Default0, App_Web_mainpage2.aspx.cdcab7d2" %>
	...
	pagelog(3);
                                            ...
                                            <td align="left">
                                                <dx:ASPxHyperLink ID="ASPxHyperLink1" runat="server" 
                                                    ...
                                                    Text="ASPxHyperLink" ToolTip="時段業績分析" />
                                            </td>
                                        </tr>
                                    </table>
                                </asp:Panel>
