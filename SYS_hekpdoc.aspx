<%@ page title="" language="C#" masterpagefile="~/MainPage.master" autoeventwireup="true" inherits="SYS_hekpdoc, App_Web_sys_hekpdoc.aspx.cdcab7d2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <dx:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="0" 
        ...
        Height="800px">
        <TabPages>
            <dx:TabPage Name="Tab01" Text="問與答">
                <ContentCollection>
