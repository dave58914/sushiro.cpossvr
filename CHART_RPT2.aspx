<%@ page title="" language="C#" masterpagefile="~/MainPage.master" autoeventwireup="true" inherits="CHART_RPT2, App_Web_chart_rpt2.aspx.cdcab7d2" %>
                ...
                <ContentCollection>
                    <dx:ContentControl runat="server" SupportsDisabledAttribute="True">
                                    ...
                                    <dx:PanelContent runat="server" SupportsDisabledAttribute="True">
                                        <div align="left">
                                            <table>
                                                ...
                                                <tr>
                                                    <td align="left">
                                                        <asp:Panel ID="Panel6" runat="server" Width="325px" HorizontalAlign="Left">
                                                            <table class="style8">
                                                                <tr>
                                                                    <td align="right" style="font-family: 王漢宗細圓體繁; font-size: small">
                                                                        過濾條件</td>
                                                ...
                                                <tr>
                                                    <td align="left">
                                                        <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" 
                                                            ClientInstanceName="chart" Height="400px" Width="1000px">
                                                            <fillstyle>
                                                                <optionsserializable>
                        ...
                        <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                            ...
                            SelectCommand="exec dbo.CHART_RPT2 @BEGDT, @ENDDT, @STORE_NO">
                            <SelectParameters>
